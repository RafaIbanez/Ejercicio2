...
package ejercicio2;
/**
 * Consulta de la tabla Fabricantes
 * @version Version : 1.0 31 de Enero de 2017
 * @author Jose Rafael Ibañez Zarzo
 * @see <a> http://teceinval.com </a>
 */
public class FabricantesConsulta extends javax.swing.JFrame {

/**
 * Consulta de la tabla Fabricantes
 */
    public FabricantesConsulta() {
        initComponents();
    ...
    private void initComponents() {
        ...
        LabelTITULO.setText("CONSULTA DE FABRICANTES");
...
// #############################################################################
    FabricantesBusqueda busqueda = new FabricantesBusqueda();
...
// #############################################################################
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(FabricantesConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FabricantesConsulta().setVisible(true);
            }
        });
    }
